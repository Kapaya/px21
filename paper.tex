...
\begin{abstract}
  ...
  write site-specific adapters to map website data to a table view
  through which the customizations are made. This means that end-users
  can only customize a website if a programmer has written an adapter
  for it. Furthermore, end-users do not have the ability to extend
  adapters in order to perform new customizations or repair adapters to
